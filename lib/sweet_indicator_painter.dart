...
class SweetIndicatorPainter extends IndicatorPainter {
  ...
  }) : super(controller: controller, indicator: indicator, indicatorSize: indicatorSize, tabKeys: tabKeys, old: old);
  ...
  Rect indicatorRect(Size? tabBarSize, int? tabIndex) {
    ...
    //return Rect.fromLTWH(tabLeft, 0.0, tabRight - tabLeft, tabBarSize.height);
      ...
      return Rect.fromLTRB(
          tabLeft +
              (currentTabOffsets![tabIndex + step] - tabLeft + getDelta(tabIndex + step)) *
                  InterpolationTween(
                    inputRange: <double?>[
                      tabIndex.toDouble(),
          ...
          0.0,
          tabRight +
              (currentTabOffsets![tabIndex + step + 1] - tabRight - getDelta(tabIndex + step)) *
                  InterpolationTween(
                    inputRange: [tabIndex.toDouble(), tabIndex.toDouble() + step / 2, tabIndex.toDouble() + step],
                    outputRange: [0, 1, 1],
                  )
                      .evaluate(
                        controller.animation!,
      ...
      return Rect.fromLTRB(
          ...
          0.0,
          tabRight +
              (currentTabOffsets![tabIndex] - tabRight - getDelta(tabIndex - step)) *
                  InterpolationTween(
                    inputRange: [
                      tabIndex.toDouble() - step,
                      tabIndex.toDouble() - step / 2,
